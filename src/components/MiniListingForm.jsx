...
export const MiniListingForm = ({ bookings, required }) => {
    ...
    return (
    <div className="w-full sm:w-[300px] flex flex-col justify-start items-center p-4 bg-white w-full sm:w-[300px] text-center min-h-[400px] z-50">
